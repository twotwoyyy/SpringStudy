			...
			<form method="post" action="../board/reply_ok.do">
				<table class="table">
					...
					<tr>
						...
						<td width=80%><textarea rows="10" cols="50" name="content" required></textarea>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2" class="text-center">
							<button class="btn-sm btn-info">답변하기</button> <input type=button
							class="btn-sm btn-warning" value="취소"
