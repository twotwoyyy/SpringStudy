...
<body>
	<div class="container">
		...
		<h3 class="text-center">실시간 박스오피스</h3>
			<div class="col-sm-7">
				<div class="col-md-4" v-for="vo in movie_list" v-on:click="detail_data(vo)">
					<div class="thumbnail">
					<img :src="'https://www.kobis.or.kr'+vo.thumbUrl" style="width: 250px;height: 150px">
						<div class="caption">
							<p>{{vo.movieNm}}</p>
						</div>
					</div>
