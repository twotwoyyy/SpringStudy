            	...
            	<table class="table">
            		<tr>
            			<td class="text-center">
            				<img :src="shop_detail.poster" style="width: 800px;height:300px">
            			</td>
            		</tr>
            		<tr>
            			<td class="text-center"><h4>{{shop_detail.title}}</h4></td>
            		</tr>
            		<tr>
            			<td class="text-center">{{shop_detail.msg}}</td>
            		</tr>
            		<tr>
            			<td class="text-center">{{shop_detail.address}}</td>
            		</tr>
            		<tr>
            			<td class="text-center">
							        ...
							        <div class="option">
							            <div>
							                <form onsubmit="searchPlaces(); return false;">
							                    키워드 : <input type="text" :value="shop_detail.addr+' 맛집'" id="keyword" size="15"> 
