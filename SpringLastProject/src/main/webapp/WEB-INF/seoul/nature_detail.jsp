...
<body>
            ...
            <div class="row">
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">서울 명소</li>
            	...
            	<table class="table">
            		<tr>
            			<td class="text-center">
            				<img :src="nature_detail.poster" style="width: 800px;height:300px">
            			</td>
            		</tr>
            		<tr>
            			<td class="text-center"><h4>{{nature_detail.title}}</h4></td>
            		</tr>
            		<tr>
            			<td class="text-center">{{nature_detail.msg}}</td>
            		</tr>
            		<tr>
            			<td class="text-center">{{nature_detail.address}}</td>
            		</tr>
            		<tr>
            			<td class="text-center">
            				<button class="btn-sm btn-primary" onclick="javascript:history.back()">목록</button>
            			</td>
            		</tr>
            		<tr>
						<td>
							        ...
							        <div class="option">
							            <div>
							                <form onsubmit="searchPlaces(); return false;">
							                    키워드 : <input type="text" :value="nature_detail.addr+' 맛집'" id="keyword" size="15"> 
    ...
    <script>
    	let detailApp=Vue.createApp({
    		...
    		mounted(){
    			// 서버로부터 데이터 읽기
    			axios.get('../seoul/nature_detail_vue.do',{
    				params:{
    					no:this.no
    				}
    			}).then(res=>{
    				console.log(res.data)
    				this.nature_detail=res.data
